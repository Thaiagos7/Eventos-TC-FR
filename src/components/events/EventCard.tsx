...
export function EventCard({ event, index = 0 }: EventCardProps) {
  ...
  return (
    <motion.article
      ...
      className="group glass-card flex h-full flex-col rounded-[1.9rem] p-4 card-hover"
    >
      <div className="mb-4 rounded-[1.5rem] border border-foreground/10 bg-[hsl(var(--paper-strong)/0.55)] p-4 poster-grid-bg">
        ...
        {event.coverImage ? (
          ...
          <div className="flex min-h-[10rem] items-center justify-center rounded-[1.3rem] border border-foreground/10 bg-[hsl(var(--paper-strong)/0.72)] p-5 text-center">
      ...
      <div className="flex flex-1 flex-col gap-4 px-1 pb-1">
        ...
        <div className="space-y-2.5 rounded-[1.3rem] border border-foreground/10 bg-[hsl(var(--paper-strong)/0.55)] p-4 shadow-sm">
